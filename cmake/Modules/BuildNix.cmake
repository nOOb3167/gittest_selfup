...
# gittest_net4_crash_handler_test

SET(GITTEST_NET4_CRASH_HANDLER_TEST_HEADERS
  include/gittest/net4.h
  ${GITTEST_LIB_HEADERS}
  )

SET(GITTEST_NET4_CRASH_HANDLER_TEST_SOURCES
  src/net4_epoll.cpp
  src/net4_serv.cpp
...
ADD_EXECUTABLE(gittest_net4_crash_handler_test ${GITTEST_NET4_CRASH_HANDLER_TEST_HEADERS} ${GITTEST_NET4_CRASH_HANDLER_TEST_SOURCES})
...
SET_PROPERTY(TARGET gittest_net4_crash_handler_test PROPERTY SUFFIX ".exe")
...
TARGET_LINK_LIBRARIES(gittest_net4_crash_handler_test gittest_common ${GITTEST_DEP_LIBRARIES})
...
TARGET_INCLUDE_DIRECTORIES(gittest_net4_crash_handler_test PUBLIC ${GITTEST_SELFUP_INCLUDE_DIRS})
